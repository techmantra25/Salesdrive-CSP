  ...
  return (
    <div className="min-h-screen flex bg-white dark:bg-gray-900">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700">
        ...
        {/* Content */}
        <div className="relative z-10 flex flex-col justify-start w-full p-12 text-white">
          {/* Logo */}
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-3 bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/20">
                ...
                <div>
                  <h3 className="font-semibold mb-0.5 text-sm">Advanced Analytics</h3>
              ...
              <div className="flex items-start gap-3 bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/20">
                ...
                <div>
                  <h3 className="font-semibold mb-0.5 text-sm">Enterprise Security</h3>
                  <p className="text-xs text-blue-100">
              ...
              <div className="flex items-start gap-3 bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/20">
                ...
                <div>
                  <h3 className="font-semibold mb-0.5 text-sm">Revenue Growth</h3>
                  <p className="text-xs text-blue-100">
