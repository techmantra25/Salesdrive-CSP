...
export const SupplierMasterView = () => {
        ...
        if (result) {
          try {
            ...
            if (res?.status === 200) {
              toast.success(
                `Supplier ${
                  supplier.status === "active" ? "deactivated" : "activated"
                } successfully`
              );
            }
          } catch (error) {
          ...
          if (result) {
            try {
              ...
              if (
                ...
                toast.error(
                  `${res?.data?.skippedCount} rows skipped, ${
                    res?.data?.uploadedCount ? res?.data?.uploadedCount : 0
